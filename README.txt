...
3) Type search keyword into the next line below that says "Type search here!".  The search operates only one word at a time and is NOT case sensative.
4) Click the Go! button to find results.